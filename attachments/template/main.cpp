...
class HelloTriangleApplication
{
  ...
  private:
	...
	vk::raii::Semaphore              renderFinishedSemaphore  = nullptr; // semaphores for swapchain operations (entirely on gpu)
	vk::raii::Fence                  drawFence                = nullptr; // waiting for previous frame to finish
