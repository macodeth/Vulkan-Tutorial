...
class HelloTriangleApplication
{
  ...
  private:
    ...
    std::vector<vk::raii::Buffer>       uniformBuffers; // buffer and memory for ubo
    ...
    void createTextureImage() {
        ...
        // upload image to gpu for fast access
        ...
        transitionImageLayout(commandBuffer, textureImage, vk::ImageLayout::eUndefined, vk::ImageLayout::eTransferDstOptimal); // transition to layout optimized for receiving data
        copyBufferToImage(commandBuffer, stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight));
        transitionImageLayout(commandBuffer, textureImage, vk::ImageLayout::eTransferDstOptimal, vk::ImageLayout::eShaderReadOnlyOptimal); // transition to layout optimized for shader access
